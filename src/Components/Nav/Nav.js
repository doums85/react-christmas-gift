                    ...
                    <div className={toggle ? "show-menu nav__menu" : "nav__menu"}>
                        <ul className="nav__list">
                            <li  className="nav__item">
                                <Link to="home"  className="nav__link" activeClass="active-link" spy={true} smooth={true} duration={100} >Home</Link>
                            </li>

                            <li  className="nav__item">
                                <Link to="share"  className="nav__link" activeClass="active-link" spy={true} smooth={true} duration={100} >Share</Link>
                            </li>
                            ...
                            <li  className="nav__item">
                                <Link to="accessory" className="nav__link" activeClass="active-link" spy={true} smooth={true} duration={100}  >Accessory</Link>
                            </li>
