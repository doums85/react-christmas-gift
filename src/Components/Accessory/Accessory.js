    ...
    <section className="accessory section bd-container" name="accessory">
      ...
      <div className="accessory__container bd-grid">
        {accessoryData.map((el) => {
          return (
            <div data-aos="fade-down" data-aos-offset="500" key={uuidv4()} className="accessory__content">
              <img src={el.image} alt="" className="accessory__img" />
              <h3 className="accessory__title">{el.title}</h3>
              <span className="accessory__category">Accessory</span>
              <span className="accessory__price">{el.price}</span>
